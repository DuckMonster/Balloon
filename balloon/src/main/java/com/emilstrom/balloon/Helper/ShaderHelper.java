...
public class ShaderHelper {
	...
	public static String readTextFile(int resourceID) {
		InputStream inputStream = BalloonGame.context.getResources().openRawResource(resourceID);
	...
	public static int createShader(int shaderType, int sourceRawID) {
		...
		Log.v(BalloonGame.TAG, "Shader debug: " + GLES20.glGetShaderInfoLog(shader));
